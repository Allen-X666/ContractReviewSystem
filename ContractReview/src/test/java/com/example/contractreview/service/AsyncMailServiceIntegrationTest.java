...
/**
 * AsyncMailService 集成测试类
 * 使用 application.yml 中配置的邮件服务器发送真实邮件
 */
@Slf4j
@SpringBootTest
public class AsyncMailServiceIntegrationTest {
    ...
    public void testSendReviewCompleteEmail() throws InterruptedException {
        ...
        log.info("审查完成邮件发送测试结束，请检查邮箱是否收到邮件");
    }
     ...
     */
    @Test
    public void testSendAllTypes() throws InterruptedException {
        log.info("开始批量发送所有类型邮件到 {}...", fromEmail);
